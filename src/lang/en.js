...
const en = {
  ...
  common: {
    ...
    updateSuccess: 'Modification Success',
  ...
  merchant: {
    ...
    newMerchant: {
      ...
      form: {
        ...
        empeoyment_sataus: 'Employment Status',
        vofing_share: 'Voting Share',
      ...
      requiredRule: {
        ...
        rule51: 'Please select Representation',
      ...
      rule44: 'The total number of voting share can not be more than 100',
  ...
  batch: {
    ...
    tip: {
      ...
      template: '《mchnt batch create excel.xlsx》',
      template_shop: '《store batch create excel.xlsx》',
      and: 'and',
      title: 'Tip',
    ...
    manual1: 'Please download template《mchnt batch create excel.xlsx》and fill in all necessary infos of on-boarding merchants.',
    manual1_shop: 'Please download template《store batch create excel.xlsx》and fill in all necessary infos of on-boarding stores.',
  ...
  agent: {
    ...
    baseInfo: 'Essential Info',
    settleInfo: 'Clearing Info',
